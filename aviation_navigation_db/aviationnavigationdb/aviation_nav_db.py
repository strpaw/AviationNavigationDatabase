...
class AviationNavigationDB:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'AviationNavigationDB_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&AviationNavigationDB')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'AviationNavigationDB')
        self.toolbar.setObjectName(u'AviationNavigationDB')
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&AviationNavigationDB'),
                action)
